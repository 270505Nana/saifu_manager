      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link" href="credits.html"><i class="fas fa-grip-horizontal"></i> <span>Data Tipe</span></a></li>

              <li><a class="nav-link" href="credits.html"><i class="fas fa-users"></i> <span>Data Costumer</span></a></li>
